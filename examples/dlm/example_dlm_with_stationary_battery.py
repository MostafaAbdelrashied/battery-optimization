...
batteries = [battery1, battery2, battery3, stationary_bat]
...
# TODO Repair
# plt.axhline(results.site_constraint_purchase, ls=":", label="New Site Limit", c="k")
plt.xlabel("Time")
...
file_name = Path(__file__).parents[2] / Path("figures/dlm_with_stationary_battery.png")
