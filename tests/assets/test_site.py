...
def test_site_add_charging_point(sample_site):
    new_charging_point = ChargingPoint(asset_id=1742, charging_power_kw=65, discharging_power_kw=60, expected_charging_efficiency=0.95, expected_discharging_efficiency=0.95)
...
def test_site_add_stationary_battery(sample_site):
    new_battery = StationaryBattery(id=43, capacity=200, energy_min=20, energy_max=180, 
                                    power_charge_max=100, power_discharge_max=100)
